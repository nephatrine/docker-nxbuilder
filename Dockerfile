...
RUN echo "====== TEST TOOLCHAINS ======" \
 ...
 && cmake -G "Ninja" -DCMAKE_TOOLCHAIN_FILE=/usr/lib/clang/toolchain.cmake .. \
 && ninja && ninja install \
 && cd /usr/src \
 && mkdir build-clang && cd build-clang \
 ...
 && cmake -G "Ninja" -DCMAKE_TOOLCHAIN_FILE=/usr/aarch64-linux-gnu/toolchain.cmake .. \
 && ninja && ninja install \
 && cd /usr/src \
 && mkdir build-aarch64 && cd build-aarch64 \
 ...
 && cmake -G "Ninja" -DCMAKE_TOOLCHAIN_FILE=/usr/arm-linux-gnueabihf/toolchain.cmake .. \
 && ninja && ninja install \
 && cd /usr/src \
 && mkdir build-armhf && cd build-armhf \
