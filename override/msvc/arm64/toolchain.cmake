...
set(triplet aarch64-windows-msvc)
set(winarch arm64)
...
if(EXISTS "${CLANG_CL_EXECUTABLE}")
	...
	set(CMAKE_CXX_FLAGS_INIT "-fms-compatibility-version=${_CL_VERSION}")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "/manifest:no /machine:arm64")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "/manifest:no /machine:arm64")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "/manifest:no /machine:arm64")
